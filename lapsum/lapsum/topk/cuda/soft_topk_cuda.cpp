...
std::vector<at::Tensor> jvp_cuda(at::Tensor input, at::Tensor output, at::Tensor v, float alpha);
std::vector<at::Tensor> vjp_cuda(at::Tensor input, at::Tensor output, at::Tensor v, float alpha);
